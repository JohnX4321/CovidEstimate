...
navbar=dbc.Nav(className="nav nav-pills",children=[
    dbc.NavItem(html.Img(src="http://corona-karnataka.herokuapp.com/thingsenzlogo.jpeg",height="40px")),
    ...
    dbc.DropdownMenu(label="Links",nav=True,children=[
        dbc.DropdownMenuItem([html.I(className="fa fa-instagram")," Instagram"],href=config.insta,target="_blank"),
